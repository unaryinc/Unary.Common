...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 615,             /* -Wpedantic-ms-format */
  ...
  OPT_fset_stack_executable = 1363,          /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1538,      /* -fwritable-relocated-rdata */
  ...
  OPT_list = 1597,                           /* -list */
  OPT_m128bit_long_double = 1598,            /* -m128bit-long-double */
  OPT_m16 = 1599,                            /* -m16 */
  OPT_m32 = 1600,                            /* -m32 */
  OPT_m3dnow = 1601,                         /* -m3dnow */
  OPT_m3dnowa = 1602,                        /* -m3dnowa */
  OPT_m64 = 1603,                            /* -m64 */
  OPT_m80387 = 1604,                         /* -m80387 */
  OPT_m8bit_idiv = 1605,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1606,             /* -m96bit-long-double */
  OPT_mabi_ = 1607,                          /* -mabi= */
  OPT_mabm = 1608,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1609,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1610,                 /* -maddress-mode= */
  OPT_madx = 1611,                           /* -madx */
  OPT_maes = 1612,                           /* -maes */
  OPT_malign_data_ = 1613,                   /* -malign-data= */
  OPT_malign_double = 1614,                  /* -malign-double */
  OPT_malign_functions_ = 1615,              /* -malign-functions= */
  OPT_malign_jumps_ = 1616,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1617,                  /* -malign-loops= */
  OPT_malign_stringops = 1618,               /* -malign-stringops */
  OPT_march_ = 1619,                         /* -march= */
  OPT_masm_ = 1620,                          /* -masm= */
  OPT_mavx = 1621,                           /* -mavx */
  OPT_mavx2 = 1622,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1623,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1624,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1625,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1626,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1627,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1628,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1629,                      /* -mavx512bw */
  OPT_mavx512cd = 1630,                      /* -mavx512cd */
  OPT_mavx512dq = 1631,                      /* -mavx512dq */
  OPT_mavx512er = 1632,                      /* -mavx512er */
  OPT_mavx512f = 1633,                       /* -mavx512f */
  OPT_mavx512ifma = 1634,                    /* -mavx512ifma */
  OPT_mavx512pf = 1635,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1636,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1637,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1638,                      /* -mavx512vl */
  OPT_mavx512vnni = 1639,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1640,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1641,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1642,                           /* -mbmi */
  OPT_mbmi2 = 1643,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1644,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1645,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1646,                    /* -mcet-switch */
  OPT_mcld = 1647,                           /* -mcld */
  OPT_mcldemote = 1648,                      /* -mcldemote */
  OPT_mclflushopt = 1649,                    /* -mclflushopt */
  OPT_mclwb = 1650,                          /* -mclwb */
  OPT_mclzero = 1651,                        /* -mclzero */
  OPT_mcmodel_ = 1652,                       /* -mcmodel= */
  OPT_mconsole = 1653,                       /* -mconsole */
  /* OPT_mcpu_ = 1654, */                    /* -mcpu= */
  OPT_mcrc32 = 1655,                         /* -mcrc32 */
  OPT_mcx16 = 1656,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1657,            /* -mdispatch-scheduler */
  OPT_mdll = 1658,                           /* -mdll */
  OPT_mdump_tune_features = 1659,            /* -mdump-tune-features */
  OPT_menqcmd = 1660,                        /* -menqcmd */
  OPT_mf16c = 1661,                          /* -mf16c */
  OPT_mfancy_math_387 = 1662,                /* -mfancy-math-387 */
  OPT_mfentry = 1663,                        /* -mfentry */
  OPT_mfentry_name_ = 1664,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1665,               /* -mfentry-section= */
  OPT_mfma = 1666,                           /* -mfma */
  OPT_mfma4 = 1667,                          /* -mfma4 */
  OPT_mforce_drap = 1668,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1669,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1670,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1671,                       /* -mfpmath= */
  OPT_mfsgsbase = 1672,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1673,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1674, */              /* -mfused-madd */
  OPT_mfxsr = 1675,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1676,             /* -mgeneral-regs-only */
  OPT_mgfni = 1677,                          /* -mgfni */
  OPT_mhard_float = 1678,                    /* -mhard-float */
  OPT_mhle = 1679,                           /* -mhle */
  OPT_miamcu = 1680,                         /* -miamcu */
  OPT_mieee_fp = 1681,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1682,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1683,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1684,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1685,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1686,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1687,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1688, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1689,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1690,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1691,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1692,                /* -mlong-double-80 */
  OPT_mlwp = 1693,                           /* -mlwp */
  OPT_mlzcnt = 1694,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1695,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1696,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1697,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1698,                  /* -mmitigate-rop */
  OPT_mmmx = 1699,                           /* -mmmx */
  OPT_mmovbe = 1700,                         /* -mmovbe */
  OPT_mmovdir64b = 1701,                     /* -mmovdir64b */
  OPT_mmovdiri = 1702,                       /* -mmovdiri */
  OPT_mmpx = 1703,                           /* -mmpx */
  OPT_mms_bitfields = 1704,                  /* -mms-bitfields */
  OPT_mmwaitx = 1705,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1706,            /* -mno-align-stringops */
  OPT_mno_default = 1707,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1708,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1709,                  /* -mno-push-args */
  OPT_mno_red_zone = 1710,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1711,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1712,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1713,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1714,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1715,                          /* -mpc32 */
  OPT_mpc64 = 1716,                          /* -mpc64 */
  OPT_mpc80 = 1717,                          /* -mpc80 */
  OPT_mpclmul = 1718,                        /* -mpclmul */
  OPT_mpcommit = 1719,                       /* -mpcommit */
  OPT_mpconfig = 1720,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1721,            /* -mpe-aligned-commons */
  OPT_mpku = 1722,                           /* -mpku */
  OPT_mpopcnt = 1723,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1724, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1725,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1726,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1727,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1728,                        /* -mprfchw */
  OPT_mptwrite = 1729,                       /* -mptwrite */
  OPT_mpush_args = 1730,                     /* -mpush-args */
  OPT_mrdpid = 1731,                         /* -mrdpid */
  OPT_mrdrnd = 1732,                         /* -mrdrnd */
  OPT_mrdseed = 1733,                        /* -mrdseed */
  OPT_mrecip = 1734,                         /* -mrecip */
  OPT_mrecip_ = 1735,                        /* -mrecip= */
  OPT_mrecord_mcount = 1736,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1737,                 /* -mrecord-return */
  OPT_mred_zone = 1738,                      /* -mred-zone */
  OPT_mregparm_ = 1739,                      /* -mregparm= */
  OPT_mrtd = 1740,                           /* -mrtd */
  OPT_mrtm = 1741,                           /* -mrtm */
  OPT_msahf = 1742,                          /* -msahf */
  OPT_msgx = 1743,                           /* -msgx */
  OPT_msha = 1744,                           /* -msha */
  OPT_mshstk = 1745,                         /* -mshstk */
  OPT_mskip_rax_setup = 1746,                /* -mskip-rax-setup */
  OPT_msoft_float = 1747,                    /* -msoft-float */
  OPT_msse = 1748,                           /* -msse */
  OPT_msse2 = 1749,                          /* -msse2 */
  OPT_msse2avx = 1750,                       /* -msse2avx */
  OPT_msse3 = 1751,                          /* -msse3 */
  OPT_msse4 = 1752,                          /* -msse4 */
  OPT_msse4_1 = 1753,                        /* -msse4.1 */
  OPT_msse4_2 = 1754,                        /* -msse4.2 */
  OPT_msse4a = 1755,                         /* -msse4a */
  /* OPT_msse5 = 1756, */                    /* -msse5 */
  OPT_msseregparm = 1757,                    /* -msseregparm */
  OPT_mssse3 = 1758,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1759,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1760, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1761,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1762, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1763,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1764,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1765,            /* -mstringop-strategy= */
  OPT_mstv = 1766,                           /* -mstv */
  OPT_mtbm = 1767,                           /* -mtbm */
  OPT_mthreads = 1768,                       /* -mthreads */
  OPT_mtls_dialect_ = 1769,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1770,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1771,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1772,                         /* -mtune= */
  OPT_municode = 1773,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1774,          /* -muse-libstdc-wrappers */
  ...
  OPT_mwin32 = 1782,                         /* -mwin32 */
  OPT_mwindows = 1783,                       /* -mwindows */
  OPT_mx32 = 1784,                           /* -mx32 */
  OPT_mxop = 1785,                           /* -mxop */
  OPT_mxsave = 1786,                         /* -mxsave */
  OPT_mxsavec = 1787,                        /* -mxsavec */
  OPT_mxsaveopt = 1788,                      /* -mxsaveopt */
  OPT_mxsaves = 1789,                        /* -mxsaves */
  OPT_n = 1790,                              /* -n */
  OPT_name_sort = 1791,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1792,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1793,              /* -no-integrated-cpp */
  OPT_no_pie = 1794,                         /* -no-pie */
  OPT_no_pthread = 1795,                     /* -no-pthread */
  OPT_nocpp = 1796,                          /* -nocpp */
  OPT_nodefaultlibs = 1797,                  /* -nodefaultlibs */
  OPT_nolibc = 1798,                         /* -nolibc */
  OPT_nophoboslib = 1799,                    /* -nophoboslib */
  OPT_nostartfiles = 1800,                   /* -nostartfiles */
  OPT_nostdinc = 1801,                       /* -nostdinc */
  OPT_nostdinc__ = 1802,                     /* -nostdinc++ */
  OPT_nostdlib = 1803,                       /* -nostdlib */
  OPT_o = 1804,                              /* -o */
  OPT_objects = 1805,                        /* -objects */
  OPT_p = 1806,                              /* -p */
  OPT_pass_exit_codes = 1807,                /* -pass-exit-codes */
  /* OPT_pedantic = 1808, */                 /* -pedantic */
  OPT_pedantic_errors = 1809,                /* -pedantic-errors */
  OPT_pg = 1810,                             /* -pg */
  OPT_pie = 1811,                            /* -pie */
  OPT_pipe = 1812,                           /* -pipe */
  OPT_posix = 1813,                          /* -posix */
  OPT_print_file_name_ = 1814,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1815,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1816,          /* -print-multi-directory */
  OPT_print_multi_lib = 1817,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1818,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1819,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1820,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1821,               /* -print-prog-name= */
  OPT_print_search_dirs = 1822,              /* -print-search-dirs */
  OPT_print_sysroot = 1823,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1824,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1825,                    /* -print-value */
  OPT_pthread = 1826,                        /* -pthread */
  OPT_quiet = 1827,                          /* -quiet */
  OPT_r = 1828,                              /* -r */
  OPT_remap = 1829,                          /* -remap */
  OPT_reverse_sort = 1830,                   /* -reverse-sort */
  OPT_s = 1831,                              /* -s */
  OPT_save_temps = 1832,                     /* -save-temps */
  OPT_save_temps_ = 1833,                    /* -save-temps= */
  OPT_shared = 1834,                         /* -shared */
  OPT_shared_libgcc = 1835,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1836,               /* -shared-libphobos */
  OPT_size_sort = 1837,                      /* -size-sort */
  /* OPT_specs = 1838, */                    /* -specs */
  OPT_specs_ = 1839,                         /* -specs= */
  OPT_static = 1840,                         /* -static */
  OPT_static_libasan = 1841,                 /* -static-libasan */
  OPT_static_libgcc = 1842,                  /* -static-libgcc */
  OPT_static_libgfortran = 1843,             /* -static-libgfortran */
  OPT_static_libgo = 1844,                   /* -static-libgo */
  OPT_static_liblsan = 1845,                 /* -static-liblsan */
  OPT_static_libmpx = 1846,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1847,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1848,               /* -static-libphobos */
  OPT_static_libstdc__ = 1849,               /* -static-libstdc++ */
  OPT_static_libtsan = 1850,                 /* -static-libtsan */
  OPT_static_libubsan = 1851,                /* -static-libubsan */
  OPT_static_pie = 1852,                     /* -static-pie */
  /* OPT_std_c__03 = 1853, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1854, */                /* -std=c++0x */
  OPT_std_c__11 = 1855,                      /* -std=c++11 */
  OPT_std_c__14 = 1856,                      /* -std=c++14 */
  OPT_std_c__17 = 1857,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1858, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1859, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1860, */                /* -std=c++20 */
  OPT_std_c__2a = 1861,                      /* -std=c++2a */
  OPT_std_c__98 = 1862,                      /* -std=c++98 */
  OPT_std_c11 = 1863,                        /* -std=c11 */
  OPT_std_c17 = 1864,                        /* -std=c17 */
  /* OPT_std_c18 = 1865, */                  /* -std=c18 */
  /* OPT_std_c1x = 1866, */                  /* -std=c1x */
  OPT_std_c2x = 1867,                        /* -std=c2x */
  /* OPT_std_c89 = 1868, */                  /* -std=c89 */
  OPT_std_c90 = 1869,                        /* -std=c90 */
  OPT_std_c99 = 1870,                        /* -std=c99 */
  /* OPT_std_c9x = 1871, */                  /* -std=c9x */
  OPT_std_f2003 = 1872,                      /* -std=f2003 */
  OPT_std_f2008 = 1873,                      /* -std=f2008 */
  OPT_std_f2008ts = 1874,                    /* -std=f2008ts */
  OPT_std_f2018 = 1875,                      /* -std=f2018 */
  OPT_std_f95 = 1876,                        /* -std=f95 */
  OPT_std_gnu = 1877,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1878, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1879, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1880,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1881,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1882,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1883, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1884, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1885, */              /* -std=gnu++20 */
